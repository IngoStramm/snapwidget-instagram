...
- Snapwidget Instagram (Nome do plugin)
- snapwidget-instagram (nome dos arquivos, nome do text domain e slug da url do repositório)
- SWI_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- swi_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Snapwidget Instagram, através do próprio sistema de atualizações do WordPress
